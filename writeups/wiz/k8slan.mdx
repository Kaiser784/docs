...
<Check>
  ...
  The policy given in the challenge is saying that any pod created in the _sensitive-ns _will have the secret injected in the FLAG env variable.
</Check>
