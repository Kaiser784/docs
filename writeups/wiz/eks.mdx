---
title: "EKS Cluster Games Writeup"
...
Looking at [hacktricks](https://book.hacktricks.wiki/en/pentesting-web/ssrf-server-side-request-forgery/cloud-ssrf.html#aws) and find meta endpoints which are accessible at http://169.254.169.254
...
This is a JWT token which we need to decode on[ ](https://jwt.io/)[jwt.io](http://jwt.io)

![E1 Avi](/images/e1.avif)
