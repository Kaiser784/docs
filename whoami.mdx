...
<Columns cols={2}>
  <Card title="work" icon="sparkles">
    [**CISPA Helmholtz Center**](https://cispa.de/en) — Security Research Intern (Jun ’23 – Sept ’24). Conducted usability analysis of Autopsy and proposed workflow improvements for digital forensics practitioners.
    ...
    **IIT Madras** — Research Intern (Dec ’21 – Dec ’22). Analyzed malware behavior, proposed labeling strategies, and prioritized threats using static/dynamic analysis tools.
    ...
    [**InCore SemiConductors Pvt Ltd**](https://incoresemi.com/) — Research Intern (May ’22 – July ’22). Developed AES driver for RISC-V secure boot and optimized encryption efficiency through iterative testing.

    [**Gurugram Police Cyber Cell**](https://gpcssi.vercel.app/) — GPCSSI Summer Intern (Jun ’21 – July ’21). Applied investigative methodologies to cybercrime cases and drafted reports aligned with legal frameworks.
  </Card>
