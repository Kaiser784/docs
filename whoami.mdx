...
<Card title="Work" icon="sparkles">
  ...
  **IIT Madras** 
  ...
  [**InCore SemiConductors Pvt Ltd**](https://incoresemi.com/) 
  Research Intern (may '22 – july '22) 
  developed AES driver for RISC-V secure boot, optimized encryption efficiency through iterative testing. 
  
  [**Gurugram Police Cyber Cell**](https://gpcssi.vercel.app/) 
  GPCSSI Summer Intern (jun '21 – july '21) 
  applied investigative methodologies to cybercrime cases, drafted reports aligned with legal frameworks.
</Card>
