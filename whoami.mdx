...
<Columns cols={2}>
  <Card title="work" icon="briefcase" iconType="regular" color="#8e62ed">
    [**CISPA Helmholtz Center**](https://cispa.de/en)

    Security Research Intern (jun '23 – sept '24)\
    conducted usability analysis of Autopsy, proposed workflow improvements for digital forensics practitioners.

    [**<u>RedHunt Labs</u>**](https://redhuntlabs.com/)

    Security Researcher (Jan ’23 – May ’23)

    researched vulnerabilities, built Golang tools, and performed penetration testing on public systems.

    **IIT Madras**

    Research Intern (Dec ’21 – Dec ’22).

    analyzed malware behavior, proposed labeling strategies, and prioritized threats using static/dynamic analysis tools.

    [**<u>InCore SemiConductors Pvt Ltd</u>**](https://incoresemi.com/)<u> </u>

    Research Intern (May ’22 – July ’22).

    developed AES driver for RISC-V secure boot and optimized encryption efficiency through iterative testing.

    [**<u>Gurugram Police Cyber Cell</u>**](https://gpcssi.vercel.app/)<u> </u>

    GPCSSI Summer Intern (Jun ’21 – July ’21).

    applied investigative methodologies to cybercrime cases and drafted reports aligned with legal frameworks.
  </Card>
  <Card title="projects" icon="projector" iconType="regular" color="#51b4ae">
    [**<u>YAPPER</u>**](https://github.com/Kaiser784/YAPPER)<u> </u>

    Extract stored passwords from browsers, credential managers, and file systems for security auditing.

    [**<u>SoundShell</u>**](https://github.com/Kaiser784/SoundShell)<u> </u>

    Encode commands into Spotify playlists to execute covert operations via playlist-based C2.

    [**<u>Sakuni NFS</u>**](https://github.com/Kaiser784/sakuni-nfs)<u> </u>

    Encrypted file system with shell commands and planned cloud integration for secure data storage.

    [**<u>golang-red-team</u>**](https://github.com/Kaiser784/golang-red-team)<u> </u>

    Suite of Go tools for web scanning, subdomain brute-forcing, and red team operations.

    [**<u>Proteus</u>**](https://github.com/Kaiser784/Proteus)<u> </u>

    Generate polyglot files to test file format abuses and identify security risks in parsers.
