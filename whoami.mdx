...
<Columns cols={2}>
  ...
  <Card title="projects" icon="projector" iconType="regular" color="#51b4ae">
    [**<u>YAPPER</u>**](https://github.com/Kaiser784/YAPPER)<u> </u>— Extract stored passwords from browsers, credential managers, and file systems for security auditing.

    [**<u>SoundShell</u>**](https://github.com/Kaiser784/SoundShell)<u> </u>— Encode commands into Spotify playlists to execute covert operations via playlist-based C2.

    [**<u>Sakuni NFS</u>**](https://github.com/Kaiser784/sakuni-nfs)<u> </u>— Encrypted file system with shell commands and planned cloud integration for secure data storage.

    [**<u>golang-red-team</u>**](https://github.com/Kaiser784/golang-red-team)<u> </u>— Suite of Go tools for web scanning, subdomain brute-forcing, and red team operations.

    [**<u>Proteus</u>**](https://github.com/Kaiser784/Proteus)<u> </u>— Generate polyglot files to test file format abuses and identify security risks in parsers.
